  ...
  return (
    <main className="min-h-screen bg-neutral-900">
      ...
      <div className="pt-[116px]">
        <section className="relative flex flex-col gap-10 overflow-hidden bg-black px-[70px] pb-20 pt-[100px] min-[1441px]:px-[150px] min-[901px]:flex-row min-[901px]:items-start min-[901px]:justify-between min-[901px]:gap-[52px] min-[901px]:pt-[160px]">
          <div
            aria-hidden="true"
          ...
          <div className="relative flex max-w-[560px] flex-col gap-5">
            <h1 className="font-mono text-[28px] leading-[33.6px] text-white">
