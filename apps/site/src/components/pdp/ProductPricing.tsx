  ...
  return (
    <section
      className={[
        ...
        // differs in height.
        "flex min-h-[304px] flex-col items-center justify-between rounded-[40px] px-10 py-10",
      ...
      <div className="flex w-full items-start justify-between gap-12">
        <div className="flex flex-col gap-2">
          ...
          <p className="mt-4 font-mono text-white">
            <span className="text-[48px] leading-[1]">{price}</span>
        ...
        <ul className="flex flex-col gap-8">
          {included.map((item) => (
            <li
              key={item}
              className="flex items-start gap-2 font-sans text-[14px] leading-[19.6px] text-white"
            >
